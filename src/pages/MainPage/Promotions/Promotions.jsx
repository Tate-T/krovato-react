...
export class Promotions extends Component {
  ...
  updateVisibleSlides = () => {
    ...
    if (width < 768) this.setState({ visibleSlides: 1 });
    else if (width < 1200) this.setState({ visibleSlides: 2 });
    else this.setState({ visibleSlides: 3 });
  };
  ...
  componentDidMount() {
    ...
    fetch("https://6832fc72c3f2222a8cb48d25.mockapi.io/promo/promolist")
  ...
  nextSlide = () => {
    const { slide, promos, visibleSlides } = this.state;
    if (slide < promos.length - visibleSlides)
  ...
  render() {
    const { promos, slide, visibleSlides } = this.state;
    return (
      <section className={style.promotions}>
        <Container>
          <div className={style.promotions__titleBox}>
            <h2 className={style.promotions__title}>Акції</h2>
            <a href="..." className={style.promotions__link}>
              Дивитись всі
              <svg
                className={style.promotions__titleArrow}
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <ul className={style.promotions__couple}>
                ...
                <li>
                  <button
                    ...
                    disabled={slide >= promos.length - visibleSlides}
                    className={style.promotions__button}
                  >
                    ❯
                  </button>
          ...
          <ul className={style.promotions__circles}>
            {promos.slice(0, Math.ceil(promos.length / visibleSlides)).map((_, i) => (
              <li key={i} className={style.promotions__circle}>
                <div
                  className={`${style.promotions__round} ${
                    i === Math.floor(slide / visibleSlides)
                      ? style.promotions__roundActive
                      : ""
                  }`}
                ></div>
              </li>
...
//             >
//               <button disabled = {slide === 1} onClick={dicrement} type="button" className={style.promotions__button}>
//                 <svg
...
//               className={style.promotions__couplePart}
//             >
//               <button disabled = {slide === 3} onClick={increment} type="button" className={style.promotions__button}>
//                 <svg
...
//           </ul>
//         </div>
//         <PromotionsList activeSlide={slide} />
//         <ul className={style.promotions__circles}>
...
//     try {
//       const data = fetch(
//         "https://6832fc72c3f2222a8cb48d25.mockapi.io/promo/promolist"
//       )
//         .then((response) => response.json())
//         .then((data) => {
//           this.setState({
...
//                   >
//                     <g clip-path="url(#clip0_79_562)">
//                       <path d="M22.9707 28.897L31.44 20.4426C31.5791 20.3024 31.7446 20.191 31.927 20.1151C32.1093 20.0391 32.3049 20 32.5025 20C32.7 20 32.8956 20.0391 33.0779 20.1151C33.2603 20.191 33.4258 20.3024 33.5649 20.4426C33.8436 20.723 34 21.1022 34 21.4976C34 21.8929 33.8436 22.2721 33.5649 22.5525L26.1579 30.0343L33.5649 37.4412C33.8436 37.7216 34 38.1008 34 38.4962C34 38.8915 33.8436 39.2707 33.5649 39.5511C33.4263 39.6925 33.261 39.805 33.0787 39.882C32.8963 39.9591 32.7004 39.9992 32.5025 40C32.3045 39.9992 32.1086 39.9591 31.9263 39.882C31.7439 39.805 31.5786 39.6925 31.44 39.5511L22.9707 31.0967C22.8188 30.9566 22.6976 30.7865 22.6147 30.5972C22.5317 30.4079 22.4889 30.2035 22.4889 29.9969C22.4889 29.7902 22.5317 29.5858 22.6147 29.3965C22.6976 29.2072 22.8188 29.0372 22.9707 28.897Z" />
//                     </g>
//                     <defs>
//                       <clipPath id="clip0_79_562">
//                         <rect
...
//                   >
//                     <g clip-path="url(#clip0_79_559)">
//                       <path d="M37.0293 28.897L28.56 20.4426C28.4209 20.3024 28.2554 20.191 28.073 20.1151C27.8907 20.0391 27.6951 20 27.4975 20C27.3 20 27.1044 20.0391 26.9221 20.1151C26.7397 20.191 26.5742 20.3024 26.4351 20.4426C26.1564 20.723 26 21.1022 26 21.4976C26 21.8929 26.1564 22.2721 26.4351 22.5525L33.8421 30.0343L26.4351 37.4412C26.1564 37.7216 26 38.1008 26 38.4962C26 38.8915 26.1564 39.2707 26.4351 39.5511C26.5737 39.6925 26.739 39.805 26.9213 39.882C27.1037 39.9591 27.2996 39.9992 27.4975 40C27.6955 39.9992 27.8914 39.9591 28.0737 39.882C28.2561 39.805 28.4214 39.6925 28.56 39.5511L37.0293 31.0967C37.1812 30.9566 37.3024 30.7865 37.3853 30.5972C37.4683 30.4079 37.5111 30.2035 37.5111 29.9969C37.5111 29.7902 37.4683 29.5858 37.3853 29.3965C37.3024 29.2072 37.1812 29.0372 37.0293 28.897Z" />
//                     </g>
//                     <defs>
//                       <clipPath id="clip0_79_559">
//                         <rect width="60" height="60" />
