...
import image from "../../../images/blog-article/article.jpg";

export const BlogArticleMain = () => {
	return (
		<>
			<div className={style.article__align}>
				<h1 className={style.article__title} id="top">
					Оформлення вітальні. Які м'які меблі краще вибрати?
				</h1>
			</div>
			<img src={image} alt="кімната" className={style.article__img} />
			<p className={style.article__descr}>
				...
				іншої кімнати, є м'які меблі. <br/> Будь-які меблі для вітальні повинні бути
