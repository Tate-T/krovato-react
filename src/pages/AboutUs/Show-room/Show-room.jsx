            ...
            <div className={style.showRoom__container}>
              ...
              >
                ...
                <h3 className={style.showRoom__subtitle}>
                  Наші фахівці допоможуть Вам підібрати матеріали і комплектуючі
                  з урахуванням Ваших побажань.
                </h3>
                <p className={style.showRoom__text}>
                  У нас є виставка, на якій Ви можете побачити найпопулярніші
                  моделі ліжок та тумбочок, а також полежати на різних моделях
                  матраців та підібрати собі оптимальний матрац для комфортного
                  сну. Адреса виставки, а також карту проїзду можна побачити в
                  розділі "Контакти".
                </p>
                <button onClick={this.toggleModal} className={style.showRoom__btn}>
                  <span className={style.showRoom__span}>
                    Відкрити контакти
                  </span>
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    className={style.showRoom__icon}
                  >
                    <path
