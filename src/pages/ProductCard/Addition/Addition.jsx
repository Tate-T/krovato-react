...
const Additions = () => {
  const additionProducts = useSelector((state) => state.addition.AdditionProduct);
  ...
  useEffect(() => {
    dispatch(AdditionAPIThunk())
  },[])
  return (
    <section className={style.addition}>
      <div className={containerStyle.container}>
        <h2 className={style.addition__title}>
          Відмінно доповнюють спальню тумба або комод
        </h2>
        <ul className={style.addition__list}>
          {additionProducts.map((product, indx) => {
             let favorite = isFavorite(product.title)
            return (
              <li className={style.addition__item} key={indx}>
                <img
                  className={style.addition__img}
                  src={product.imageSrc}
                  alt={product.alt}
                />
                <p className={style.addition__size}>Розмір: {product.size.height} x {product.size.width} x {product.size.length}</p>
                ...
                <div className={style.addition__activeFlex}>
                  ...
                  <p className={style.addition__active}> {product.inStock ? "В наявності":"Немає в наявності"}</p>
                </div>
                <div className={style.addition__itemFooter}>                  
                    <div className={style.addition__costFlex}>
                        <p className={style.addition__nonCost}>{product.oldPrice ? `${product.oldPrice} грн`:""}</p>
                        <p className={style.addition__cost}>{product.price} грн</p>
                    </div>
                  ...
                  <div className={style.addition__obraneBc}>
                    ...
                    >
                      <svg
                        className={style.addition__obraneSvg}
                        xmlns="http://www.w3.org/2000/svg"
                        width="50"
                        height="50"
                        viewBox="0 0 50 50"
                  ...
                  <div className={style.addition__koshykBc}>
                    <button>
                      <svg
                        className={style.addition__koshykSvg}
                        xmlns="http://www.w3.org/2000/svg"
                        width="50"
                        height="50"
                        viewBox="0 0 50 50"
