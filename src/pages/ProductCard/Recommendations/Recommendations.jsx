...
export class Recommendations extends Component {
    ...
    state = {
        productsData: this.props.productsData.slice(0, 4)
    }
                                    ...
                                    <div className={style.recommendations__itemFooter}>
                                        ...
                                        {product.oldPrice !== undefined ?
                                            <div className={style.recommendations__costFlex}>
                                                <p className={style.recommendations__nonCost}>{product.oldPrice}</p>
                                                <p className={style.recommendations__cost}>{product.price}</p>
                                            </div>
                                            :
                                            <div className={style.recommendations__costFlex}>
                                                <p className={style.recommendations__cost}>{product.price}</p>
                                        ...
                                        <div className={style.recommendations__obraneBc}>
                                            <button>
                                                <svg className={style.recommendations__obraneSvg} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
