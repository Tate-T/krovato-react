...
import { openModal , closeModal , setRating } from '../../../redux/productDescription/productDescriptionSlice'
import { getRespond , addRespond } from '../../../redux/productDescription/productDescriptionSlice'
import { useEffect , useState } from 'react'
export const ProductDescription  = () => {
const [name, setName] = useState("");
const [email, setEmail] = useState("");
const [review, setReview] = useState("");
const stylesDescription = useSelector(state => state.productDescription.styles)
const selectedStyle = useSelector(state => state.productDescription.selectedStyle)
const rating = useSelector(state => state.productDescription.rating)
...
return(
       ...
       {stylesDescription.map((item , index) => (
     <li className={style.description__item} key={index}>
        <button className={style.description__btn} onClick={() => dispatch(openModal(item))}>
            <img src={item.img} alt={item.alt} className={style.description__img}/>
        </button>
     </li>
       ))}
        </ul>
        {selectedStyle && selectedStyle.img && (
        <div className={style.imgBackdrop} onClick={() => dispatch(closeModal())}>
            <div className={style.imgModal}>
                <img src={selectedStyle.img} alt={selectedStyle.alt} className={style.description__img} />
            </div>
        </div>
        )}
        </div>
        <div className={style.descriptionForm__bug}>
            <form className={style.descriptionForm}>
