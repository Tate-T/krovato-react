        ...
        <section className={style.products}>
            <Container>
                <div className={style.products__titleBox}>
                    ...
                    <Link  className={style.products__link} to="/catalog">
                        Дивитись всі
                        <svg className={style.products__arrow} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
